...
def main():
    ...
    # STINKER, GOOD, STINKER x 3, GOOD, STINKER x 3, GOOD, ... etc.
    # We shall combine 3 GOOD to make one TEXT
    ...
    for caption in webvtt.from_string(vtt):
        ...
        # Pattern matching useful captions lines since there is 
        # A lot of duplicate texts and phrases, likely due to the
        # captions being auto generated by YouTube
        if i % 4 == 1:
            print(caption.start)
            print(caption.end)
            print(text + "\n")
